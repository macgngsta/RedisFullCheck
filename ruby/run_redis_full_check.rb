...
# call RedisFullCheck
cmd = `../bin/redis-full-check -s #{source_redis_endpoint} -p #{source_redis_pwd} -t #{target_memorydb_auth} -a #{target_memorydb_auth} --targetdbtype=1 --comparemode=2 --comparetimes=3`
